  ...
  return (
    <section className="grid lg:grid-cols-2 p-4 lg:p-6 h-full">
      ...
      <div className="flex items-center justify-center">
        <div>
          <h1 className="uppercase text-3xl text-center lg:text-4xl xl:text-5xl mb-4 lg:mb-6">
          ...
          <div className="flex flex-col gap-4 lg:gap-6">
            ...
            />
            <TextBlock description={`Inspired by my cousin, Faizan Arif, a software engineer, I began my journey into web development in April 2023 while balancing my studies in the 12th standard. With Faizan's support and online courses he purchased for me, I delved into HTML, CSS, and Sass, and then progressed to JavaScript, React, and Next.js. Despite his busy schedule, Faizan was always there to help whenever I was stuck, allowing me to learn frontend development and its frameworks in just eight months.`} />
            <TextBlock description={`After passing my 12th standard, I decided to leave formal education behind and fully embrace the world of web development. By the end of 2023, I started working with clients, leveraging my skills to create responsive, dynamic web applications. At the start of 2024, I took a significant step in my career by joining Infinity Devs as a frontend developer. Here, I continue to grow, learning new technologies and refining my craft every day.`} />
            <TextBlock description={`I am passionate about creating exceptional digital experiences and continually seek to push the boundaries of frontend development. Join me as I share insights, tutorials, and tricks to help others navigate the ever-evolving landscape of web technology.`} />
            <Button asChild>
              <Link href={''} className="self-start" >Hire Me</Link>
            </Button>
          </div>
        </div>
      </div>
